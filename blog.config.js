...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '田径中国', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '田径中国-为中国人分享全球的优质田径比赛', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://usainbolt.eu.org', // 网站地址
